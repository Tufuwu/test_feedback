...
class Projects(Endpoint):
    ...
    @property
    def baseurl(self):
        return "{0}/sites/{1}/projects".format(
    ...
    def get(self, req_options=None):
        ...
        all_project_items = ProjectItem.from_response(
            server_response.content, self.parent_srv.namespace
        )
    ...
    def update(self, project_item):
        ...
        updated_project = ProjectItem.from_response(
            server_response.content, self.parent_srv.namespace
        )[0]
    ...
    def create(self, project_item):
        ...
        new_project = ProjectItem.from_response(
            server_response.content, self.parent_srv.namespace
        )[0]
