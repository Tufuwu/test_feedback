...
class ConnectionItem(object):
    ...
    def from_response(cls, resp, ns):
        ...
        for connection_xml in all_connection_xml:
            ...
            connection_item.embed_password = string_to_bool(
                connection_xml.get("embedPassword", "")
            )
    ...
    def from_xml_element(cls, parsed_response, ns):
        ...
        for connection_xml in all_connection_xml:
            ...
            if connection_credentials is not None:
                ...
                connection_item.connection_credentials = (
                    ConnectionCredentials.from_xml_element(connection_credentials)
                )
