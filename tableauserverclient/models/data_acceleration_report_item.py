...
class DataAccelerationReportItem(object):
    ...
    def _parse_element(comparison_record_xml, ns):
        ...
        unaccelerated_session_count = comparison_record_xml.get(
            "unacceleratedSessionCount", None
        )
        avg_non_accelerated_plt = comparison_record_xml.get(
            "averageNonAcceleratedPLT", None
        )
        accelerated_session_count = comparison_record_xml.get(
            "acceleratedSessionCount", None
        )
    ...
    def from_response(cls, resp, ns):
        ...
        all_comparison_records_xml = parsed_response.findall(
            ".//t:comparisonRecord", namespaces=ns
        )
