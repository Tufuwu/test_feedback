...
class ProjectItem(object):
    ...
    def _parse_common_tags(self, project_xml, ns):
        ...
        if project_xml is not None:
            (_, name, description, content_permissions, parent_id) = (
    ...
    def _set_values(
        self, project_id, name, description, content_permissions, parent_id, owner_id
    ):
    ...
    def from_response(cls, resp, ns):
        ...
        for project_xml in all_project_xml:
            (id, name, description, content_permissions, parent_id, owner_id) = (
