...
class PermissionsRule(object):
    ...
    def from_response(cls, resp, ns=None):
        ...
        rules = []
        permissions_rules_list_xml = parsed_response.findall(
            ".//t:granteeCapabilities", namespaces=ns
        )
    ...
    def _parse_grantee_element(grantee_capability_xml, ns):
        ...
        grantee_element = grantee_capability_xml.findall(
            ".//*[@id]", namespaces=ns
        ).pop()
        ...
        if grantee_type == "user":
            ...
            raise UnknownGranteeTypeError(
                "No support for grantee type of {}".format(grantee_type)
            )
