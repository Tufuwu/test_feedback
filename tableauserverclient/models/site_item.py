...
class SiteItem(object):
    ...
    def __init__(
        ...
        self.auto_suspend_refresh_inactivity_window = (
    ...
    def _parse_element(site_xml, ns):
        ...
        scheduling_flows_enabled = string_to_bool(
            site_xml.get("schedulingFlowsEnabled", "")
        )
        allow_subscription_attachments = string_to_bool(
            site_xml.get("allowSubscriptionAttachments", "")
        )
        ...
        request_access_enabled = string_to_bool(
            site_xml.get("requestAccessEnabled", "")
        )
        ...
        commenting_mentions_enabled = string_to_bool(
            site_xml.get("commentingMentionsEnabled", "")
        )
        catalog_obfuscation_enabled = string_to_bool(
            site_xml.get("catalogObfuscationEnabled", "")
        )
        flow_auto_save_enabled = string_to_bool(site_xml.get("flowAutoSaveEnabled", ""))
        web_extraction_enabled = string_to_bool(
            site_xml.get("webExtractionEnabled", "")
        )
        metrics_content_type_enabled = string_to_bool(
            site_xml.get("metricsContentTypeEnabled", "")
        )
        notify_site_admins_on_throttle = string_to_bool(
            site_xml.get("notifySiteAdminsOnThrottle", "")
        )
        authoring_enabled = string_to_bool(site_xml.get("authoringEnabled", ""))
        custom_subscription_email_enabled = string_to_bool(
            site_xml.get("customSubscriptionEmailEnabled", "")
        )
        custom_subscription_email = site_xml.get("customSubscriptionEmail", None)
        custom_subscription_footer_enabled = string_to_bool(
            site_xml.get("customSubscriptionFooterEnabled", "")
        )
        ...
        mobile_biometrics_enabled = string_to_bool(
            site_xml.get("mobileBiometricsEnabled", "")
        )
        sheet_image_enabled = string_to_bool(site_xml.get("sheetImageEnabled", ""))
        derived_permissions_enabled = string_to_bool(
            site_xml.get("derivedPermissionsEnabled", "")
        )
        ...
        auto_suspend_refresh_enabled = string_to_bool(
            site_xml.get("autoSuspendRefreshEnabled", "")
        )
        auto_suspend_refresh_inactivity_window = site_xml.get(
            "autoSuspendRefreshInactivityWindow", None
        )
        if auto_suspend_refresh_inactivity_window:
            auto_suspend_refresh_inactivity_window = int(
                auto_suspend_refresh_inactivity_window
            )
