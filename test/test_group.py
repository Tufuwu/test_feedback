...
class GroupTests(unittest.TestCase):
    ...
    def test_populate_users(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl
                + "/e7833b48-c6f7-47b5-a2a7-36e7dd232758/users?pageNumber=1&pageSize=100",
                text=response_xml,
                complete_qs=True,
            )
    ...
    def test_delete(self):
        with requests_mock.mock() as m:
            m.delete(
                self.baseurl + "/e7833b48-c6f7-47b5-a2a7-36e7dd232758", status_code=204
            )
    ...
    def test_remove_user(self):
        ...
        with requests_mock.mock() as m:
            url = (
                self.baseurl + "/e7833b48-c6f7-47b5-a2a7-36e7dd232758/users"
    ...
    def test_add_user(self):
        ...
        with requests_mock.mock() as m:
            ...
            self.server.groups.add_user(
                single_group, "5de011f8-5aa9-4d5b-b991-f462c8dd6bb7"
            )
            self.server.groups.populate_users(single_group)
            self.assertEqual(1, len(list(single_group.users)))
            user = list(single_group.users).pop()
    ...
    def test_update(self):
        ...
        with requests_mock.mock() as m:
            m.put(
                self.baseurl + "/ef8b19c0-43b6-11e6-af50-63f5805dbe3c",
                text=response_xml,
            )
