...
class SiteTests(unittest.TestCase):
    ...
    def test_get_by_id(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl + "/dad65087-b08b-4603-af4e-2887b8aafc67",
                text=response_xml,
            )
            single_site = self.server.sites.get_by_id(
    ...
    def test_update(self):
        ...
        with requests_mock.mock() as m:
            m.put(
                self.baseurl + "/6b7179ba-b82b-4f0f-91ed-812074ac5da6",
                text=response_xml,
            )
    ...
    def test_update_missing_id(self):
        ...
        self.assertRaises(
            TSC.MissingRequiredFieldError, self.server.sites.update, single_site
        )
    ...
    def test_delete(self):
        with requests_mock.mock() as m:
            m.delete(
                self.baseurl + "/0626857c-1def-4503-a7d8-7907c3ff9d9f", status_code=204
            )
    ...
    def test_encrypt(self):
        with requests_mock.mock() as m:
            m.post(
                self.baseurl + "/0626857c-1def-4503-a7d8-7907c3ff9d9f/encrypt-extracts",
                status_code=200,
            )
    ...
    def test_recrypt(self):
        with requests_mock.mock() as m:
            m.post(
                self.baseurl
                + "/0626857c-1def-4503-a7d8-7907c3ff9d9f/reencrypt-extracts",
                status_code=200,
            )
            self.server.sites.re_encrypt_extracts(
                "0626857c-1def-4503-a7d8-7907c3ff9d9f"
            )

    def test_decrypt(self):
        with requests_mock.mock() as m:
            m.post(
                self.baseurl + "/0626857c-1def-4503-a7d8-7907c3ff9d9f/decrypt-extracts",
                status_code=200,
            )
