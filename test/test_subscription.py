...
class SubscriptionTests(unittest.TestCase):
    ...
    def test_get_subscriptions(self):
        ...
        self.assertEqual(
            "7617c389-cdca-4940-a66e-69956fcebf3e", subscription.schedule_id
        )
        ...
        self.assertEqual("c0d5fc44-ad8c-4957-bec0-b70ed0f8df1e", subscription.user_id)
        self.assertEqual(
            "3407cd38-7b39-4983-86a6-67a1506a5e3f", subscription.schedule_id
        )
    ...
    def test_get_subscription_by_id(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl + "/382e9a6e-0c08-4a95-b6c1-c14df7bac3e4",
                text=response_xml,
            )
            subscription = self.server.subscriptions.get_by_id(
                "382e9a6e-0c08-4a95-b6c1-c14df7bac3e4"
            )
    ...
    def test_create_subscription(self):
        ...
        with requests_mock.mock() as m:
            ...
            new_subscription = TSC.SubscriptionItem(
                "subject",
                "4906c453-d5ec-4972-9ff4-789b629bdfa2",
                "8d30c8de-0a5f-4bee-b266-c621b4f3eed0",
                target_item,
            )
        ...
        self.assertEqual(
            "960e61f2-1838-40b2-bba2-340c9492f943", new_subscription.target.id
        )
        self.assertEqual("Workbook", new_subscription.target.type)
        self.assertEqual(
            "4906c453-d5ec-4972-9ff4-789b629bdfa2", new_subscription.schedule_id
        )
        self.assertEqual(
            "8d30c8de-0a5f-4bee-b266-c621b4f3eed0", new_subscription.user_id
        )

    def test_delete_subscription(self):
        with requests_mock.mock() as m:
            m.delete(
                self.baseurl + "/78e9318d-2d29-4d67-b60f-3f2f5fd89ecc", status_code=204
            )
