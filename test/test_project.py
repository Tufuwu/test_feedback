...
POPULATE_WORKBOOK_DEFAULT_PERMISSIONS_XML = (
...
class ProjectTests(unittest.TestCase):
    ...
    def test_get(self):
        ...
        self.assertEqual(
            "The default project that was automatically created by Tableau.",
        ...
        self.assertEqual(
            "dd2239f6-ddf1-4107-981a-4cf94e415794", all_projects[0].owner_id
        )
        ...
        self.assertEqual(
            "2a47bbf8-8900-4ebb-b0a4-2723bd7c46c3", all_projects[1].owner_id
        )
        ...
        self.assertEqual(
            "1d0304cd-3796-429f-b815-7258370b9b74", all_projects[2].parent_id
        )
        self.assertEqual(
            "dd2239f6-ddf1-4107-981a-4cf94e415794", all_projects[2].owner_id
        )
    ...
    def test_delete(self):
        with requests_mock.mock() as m:
            m.delete(
                self.baseurl + "/ee8c6e70-43b6-11e6-af4f-f7b0d8e20760", status_code=204
            )
    ...
    def test_update(self):
        ...
        with requests_mock.mock() as m:
            m.put(
                self.baseurl + "/1d0304cd-3796-429f-b815-7258370b9b74",
                text=response_xml,
            )
        ...
        self.assertEqual(
            "9a8f2265-70f3-4494-96c5-e5949d7a1120", single_project.parent_id
        )
    ...
    def test_update_datasource_default_permission(self):
        ...
        self.assertEqual(
            "b4488bce-80f0-11ea-af1c-976d0c1dab39", new_rules[0].grantee.id
        )
    ...
    def test_update_missing_id(self):
        ...
        self.assertRaises(
            TSC.MissingRequiredFieldError, self.server.projects.update, single_project
        )
    ...
    def test_populate_permissions(self):
        ...
        with requests_mock.mock() as m:
            ...
            self.assertEqual(
                permissions[0].grantee.id, "c8f2773a-c83a-11e8-8c8f-33e6d787b506"
            )
    ...
    def test_populate_workbooks(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl
                + "/9dbd2263-16b5-46e1-9c43-a76bb8ab65fb/default-permissions/workbooks",
                text=response_xml,
            )
            single_project = TSC.ProjectItem(
    ...
    def test_delete_permission(self):
        ...
        with requests_mock.mock() as m:
            ...
            m.delete(
                "{}/{}/Write/Allow".format(self.baseurl, endpoint), status_code=204
            )
    ...
    def test_delete_workbook_default_permission(self):
        ...
        with requests_mock.mock() as m:
            ...
            endpoint = "{}/default-permissions/workbooks/groups/{}".format(
                single_project._id, single_group._id
            )
            m.delete("{}/{}/Read/Allow".format(self.baseurl, endpoint), status_code=204)
            m.delete(
                "{}/{}/ExportImage/Allow".format(self.baseurl, endpoint),
                status_code=204,
            )
            m.delete(
                "{}/{}/ExportData/Allow".format(self.baseurl, endpoint), status_code=204
            )
            m.delete(
                "{}/{}/ViewComments/Allow".format(self.baseurl, endpoint),
                status_code=204,
            )
            m.delete(
                "{}/{}/AddComment/Allow".format(self.baseurl, endpoint), status_code=204
            )
            m.delete(
                "{}/{}/Filter/Allow".format(self.baseurl, endpoint), status_code=204
            )
            m.delete(
                "{}/{}/ViewUnderlyingData/Deny".format(self.baseurl, endpoint),
                status_code=204,
            )
            m.delete(
                "{}/{}/ShareView/Allow".format(self.baseurl, endpoint), status_code=204
            )
            m.delete(
                "{}/{}/WebAuthoring/Allow".format(self.baseurl, endpoint),
                status_code=204,
            )
            m.delete(
                "{}/{}/Write/Allow".format(self.baseurl, endpoint), status_code=204
            ...
            m.delete(
                "{}/{}/ExportXml/Allow".format(self.baseurl, endpoint), status_code=204
            )
            m.delete(
                "{}/{}/ChangeHierarchy/Allow".format(self.baseurl, endpoint),
                status_code=204,
            )
            m.delete(
                "{}/{}/Delete/Deny".format(self.baseurl, endpoint), status_code=204
            )
            m.delete(
                "{}/{}/ChangePermissions/Allow".format(self.baseurl, endpoint),
                status_code=204,
            )
            self.server.projects.delete_workbook_default_permissions(
                item=single_project, rule=rules
            )
