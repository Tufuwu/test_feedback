...
class DataAlertTests(unittest.TestCase):
    ...
    def test_get(self):
        ...
        self.assertEqual(
            "5de011f8-5aa9-4d5b-b991-f462c8dd6bb7", all_alerts[0].creatorId
        )
        ...
        self.assertEqual(
            "6d13b0ca-043d-4d42-8c9d-3f3313ea3a00", all_alerts[0].workbook_id
        )
        self.assertEqual("Safari stats", all_alerts[0].workbook_name)
        self.assertEqual(
            "5241e88d-d384-4fd7-9c2f-648b5247efc5", all_alerts[0].project_id
        )
    ...
    def test_get_by_id(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl + "/5ea59b45-e497-5673-8809-bfe213236f75",
                text=response_xml,
            )
            alert = self.server.data_alerts.get_by_id(
                "5ea59b45-e497-5673-8809-bfe213236f75"
            )
    ...
    def test_update(self):
        ...
        self.assertEqual(
            "6d13b0ca-043d-4d42-8c9d-3f3313ea3a00", single_alert.workbook_id
        )
        self.assertEqual("Safari stats", single_alert.workbook_name)
        self.assertEqual(
            "5241e88d-d384-4fd7-9c2f-648b5247efc5", single_alert.project_id
        )
    ...
    def test_add_user_to_alert(self):
        ...
        with requests_mock.mock() as m:
            m.post(
                self.baseurl + "/0448d2ed-590d-4fa0-b272-a2a8a24555b5/users",
                text=response_xml,
            )
    ...
    def test_delete(self):
        with requests_mock.mock() as m:
            m.delete(
                self.baseurl + "/0448d2ed-590d-4fa0-b272-a2a8a24555b5", status_code=204
            )
    ...
    def test_delete_user_from_alert(self):
        ...
        with requests_mock.mock() as m:
            m.delete(
                self.baseurl + "/{0}/users/{1}".format(alert_id, user_id),
                status_code=204,
            )
