...
class DatabaseTests(unittest.TestCase):
    ...
    def test_get(self):
        ...
        self.assertEqual(
            "9324cf6b-ba72-4b8e-b895-ac3f28d2f0e0", all_databases[1].contact_id
        )
    ...
    def test_update(self):
        ...
        with requests_mock.mock() as m:
            m.put(
                self.baseurl + "/23591f2c-4802-4d6a-9e28-574a8ea9bc4c",
                text=response_xml,
            )
        ...
        self.assertEqual(
            "9324cf6b-ba72-4b8e-b895-ac3f28d2f0e0", single_database.contact_id
        )
