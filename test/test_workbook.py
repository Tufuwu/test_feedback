...
POPULATE_CONNECTIONS_XML = os.path.join(
    TEST_ASSET_DIR, "workbook_populate_connections.xml"
)
POPULATE_PDF = os.path.join(TEST_ASSET_DIR, "populate_pdf.pdf")
POPULATE_PERMISSIONS_XML = os.path.join(
    TEST_ASSET_DIR, "workbook_populate_permissions.xml"
)
...
POPULATE_VIEWS_USAGE_XML = os.path.join(
    TEST_ASSET_DIR, "workbook_populate_views_usage.xml"
)
...
class WorkbookTests(unittest.TestCase):
    ...
    def test_get(self):
        ...
        self.assertEqual(
            "http://tableauserver/#/workbooks/1/views", all_workbooks[0].webpage_url
        )
        self.assertEqual(1, all_workbooks[0].size)
        self.assertEqual(
            "2016-08-03T20:34:04Z", format_datetime(all_workbooks[0].created_at)
        )
        self.assertEqual("description for Superstore", all_workbooks[0].description)
        self.assertEqual(
            "2016-08-04T17:56:41Z", format_datetime(all_workbooks[0].updated_at)
        )
        self.assertEqual(
            "ee8c6e70-43b6-11e6-af4f-f7b0d8e20760", all_workbooks[0].project_id
        )
        self.assertEqual("default", all_workbooks[0].project_name)
        self.assertEqual(
            "5de011f8-5aa9-4d5b-b991-f462c8dd6bb7", all_workbooks[0].owner_id
        )
        ...
        self.assertEqual(
            "http://tableauserver/#/workbooks/2/views", all_workbooks[1].webpage_url
        )
        self.assertEqual(False, all_workbooks[1].show_tabs)
        self.assertEqual(26, all_workbooks[1].size)
        self.assertEqual(
            "2016-07-26T20:34:56Z", format_datetime(all_workbooks[1].created_at)
        )
        self.assertEqual("description for SafariSample", all_workbooks[1].description)
        self.assertEqual(
            "2016-07-26T20:35:05Z", format_datetime(all_workbooks[1].updated_at)
        )
        self.assertEqual(
            "ee8c6e70-43b6-11e6-af4f-f7b0d8e20760", all_workbooks[1].project_id
        )
        self.assertEqual("default", all_workbooks[1].project_name)
        self.assertEqual(
            "5de011f8-5aa9-4d5b-b991-f462c8dd6bb7", all_workbooks[1].owner_id
        )
    ...
    def test_get_by_id(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl + "/3cc6cd06-89ce-4fdc-b935-5294135d6d42",
                text=response_xml,
            )
        ...
        self.assertEqual(
            "http://tableauserver/#/workbooks/2/views", single_workbook.webpage_url
        )
        ...
        self.assertEqual(
            "2016-07-26T20:35:05Z", format_datetime(single_workbook.updated_at)
        )
        self.assertEqual(
            "ee8c6e70-43b6-11e6-af4f-f7b0d8e20760", single_workbook.project_id
        )
        self.assertEqual("default", single_workbook.project_name)
        self.assertEqual(
            "5de011f8-5aa9-4d5b-b991-f462c8dd6bb7", single_workbook.owner_id
        )
    ...
    def test_refresh_id(self):
        ...
        with requests_mock.mock() as m:
            m.post(
                self.baseurl + "/3cc6cd06-89ce-4fdc-b935-5294135d6d42/refresh",
                status_code=202,
                text=response_xml,
            )
    ...
    def test_delete(self):
        with requests_mock.mock() as m:
            m.delete(
                self.baseurl + "/3cc6cd06-89ce-4fdc-b935-5294135d6d42", status_code=204
            )
    ...
    def test_update(self):
        ...
        with requests_mock.mock() as m:
            m.put(
                self.baseurl + "/1f951daf-4061-451a-9df1-69a8062664f2",
                text=response_xml,
            )
            single_workbook = TSC.WorkbookItem(
                "1d0304cd-3796-429f-b815-7258370b9b74", show_tabs=True
            )
        ...
        self.assertEqual(
            "1d0304cd-3796-429f-b815-7258370b9b74", single_workbook.project_id
        )
        self.assertEqual(
            "dd2239f6-ddf1-4107-981a-4cf94e415794", single_workbook.owner_id
        )
        self.assertEqual("renamedWorkbook", single_workbook.name)
        self.assertEqual(
            True, single_workbook.data_acceleration_config["acceleration_enabled"]
        )
        self.assertEqual(
            False, single_workbook.data_acceleration_config["accelerate_now"]
        )

    def test_update_missing_id(self):
        single_workbook = TSC.WorkbookItem("test")
        self.assertRaises(
            TSC.MissingRequiredFieldError, self.server.workbooks.update, single_workbook
        )
    ...
    def test_update_copy_fields(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl + "/1f951daf-4061-451a-9df1-69a8062664f2/connections",
                text=connection_xml,
            )
            m.put(
                self.baseurl + "/1f951daf-4061-451a-9df1-69a8062664f2", text=update_xml
            )
        ...
        self.assertEqual(
            single_workbook._preview_image, updated_workbook._preview_image
        )
    ...
    def test_update_tags(self):
        ...
        with requests_mock.mock() as m:
            m.put(
                self.baseurl + "/1f951daf-4061-451a-9df1-69a8062664f2/tags",
                text=add_tags_xml,
            )
            m.delete(
                self.baseurl + "/1f951daf-4061-451a-9df1-69a8062664f2/tags/b",
                status_code=204,
            )
            m.delete(
                self.baseurl + "/1f951daf-4061-451a-9df1-69a8062664f2/tags/d",
                status_code=204,
            )
            m.put(
                self.baseurl + "/1f951daf-4061-451a-9df1-69a8062664f2", text=update_xml
    ...
    def test_download(self):
        with requests_mock.mock() as m:
            m.get(
                ...
                headers={
                    "Content-Disposition": 'name="tableau_workbook"; filename="RESTAPISample.twbx"'
                },
            )
    ...
    def test_download_extract_only(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl
                + "/1f951daf-4061-451a-9df1-69a8062664f2/content?includeExtract=False",
                headers={
                    "Content-Disposition": 'name="tableau_workbook"; filename="RESTAPISample.twbx"'
                },
                complete_qs=True,
            ...
            file_path = self.server.workbooks.download(
                "1f951daf-4061-451a-9df1-69a8062664f2", include_extract=False
            )
            self.assertTrue(os.path.exists(file_path))
        os.remove(file_path)
    ...
    def test_populate_views(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl + "/1f951daf-4061-451a-9df1-69a8062664f2/views",
                text=response_xml,
            )
            single_workbook = TSC.WorkbookItem("test")
            single_workbook._id = "1f951daf-4061-451a-9df1-69a8062664f2"
    ...
    def test_populate_views_missing_id(self):
        ...
        self.assertRaises(
            ...
            self.server.workbooks.populate_views,
            single_workbook,
        )
    ...
    def test_populate_connections(self):
        ...
        with requests_mock.mock() as m:
            ...
            self.assertEqual(
                "37ca6ced-58d7-4dcf-99dc-f0a85223cbef",
                single_workbook.connections[0].id,
            )
            self.assertEqual(
                "dataengine", single_workbook.connections[0].connection_type
            )
            self.assertEqual(
                "4506225a-0d32-4ab1-82d3-c24e85f7afba",
                single_workbook.connections[0].datasource_id,
            )
            self.assertEqual(
                "World Indicators", single_workbook.connections[0].datasource_name
            )
    ...
    def test_populate_permissions(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl + "/21778de4-b7b9-44bc-a599-1506a2639ace/permissions",
                text=response_xml,
            )
            single_workbook = TSC.WorkbookItem("test")
            ...
            self.assertEqual(
                permissions[0].grantee.id, "5e5e1978-71fa-11e4-87dd-7382f5c437af"
            )
            ...
            self.assertEqual(
                permissions[1].grantee.id, "7c37ee24-c4b1-42b6-a154-eaeab7ee330a"
            )
            self.assertDictEqual(
    ...
    def test_populate_pdf(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl
                + "/1f951daf-4061-451a-9df1-69a8062664f2/pdf?type=a5&orientation=landscape",
                content=response,
            )
            single_workbook = TSC.WorkbookItem("test")
            single_workbook._id = "1f951daf-4061-451a-9df1-69a8062664f2"
    ...
    def test_populate_preview_image(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl + "/1f951daf-4061-451a-9df1-69a8062664f2/previewImage",
                content=response,
            )
            single_workbook = TSC.WorkbookItem("test")
            single_workbook._id = "1f951daf-4061-451a-9df1-69a8062664f2"
    ...
    def test_publish(self):
        ...
        self.assertEqual(
            "2016-08-18T20:31:34Z", format_datetime(new_workbook.updated_at)
        )
        self.assertEqual(
            "ee8c6e70-43b6-11e6-af4f-f7b0d8e20760", new_workbook.project_id
        )
        ...
        self.assertEqual(
            "RESTAPISample_0/sheets/GDPpercapita", new_workbook.views[0].content_url
        )
    ...
    def test_publish_with_hidden_view(self):
        ...
        with requests_mock.mock() as m:
            ...
            self.assertTrue(
                re.search(
                    rb"<views><view.*?hidden=\"true\".*?\/><\/views>", request_body
                )
            )
            self.assertTrue(
                re.search(
                    rb"<views><view.*?name=\"GDP per capita\".*?\/><\/views>",
                    request_body,
                )
            )
    ...
    def test_publish_async(self):
        ...
        with requests_mock.mock() as m:
            ...
            new_job = self.server.workbooks.publish(
                new_workbook, sample_workbook, publish_mode, as_job=True
            )
    ...
    def test_publish_multi_connection(self):
        ...
        response = RequestFactory.Workbook._generate_xml(
            new_workbook, connections=[connection1, connection2]
        )
        ...
        self.assertEqual(
            connection_results[0].find("connectionCredentials").get("name", None),
            "test",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            connection_results[1].find("connectionCredentials").get("password", None),
            "secret",
        )
    ...
    def test_publish_single_connection(self):
        ...
        response = RequestFactory.Workbook._generate_xml(
            new_workbook, connection_credentials=connection_creds
        )
        # Can't use ConnectionItem parser due to xml namespace problems
    ...
    def test_delete_extracts_all(self):
        ...
        with requests_mock.mock() as m:
            m.post(
                self.baseurl + "/3cc6cd06-89ce-4fdc-b935-5294135d6d42/deleteExtract",
                status_code=200,
            )
    ...
    def test_create_extracts_all(self):
        ...
        with requests_mock.mock() as m:
            m.post(
                self.baseurl + "/3cc6cd06-89ce-4fdc-b935-5294135d6d42/createExtract",
                status_code=200,
                text=response_xml,
            )
    ...
    def test_create_extracts_one(self):
        ...
        with requests_mock.mock() as m:
            ...
            self.server.workbooks.create_extract(
                "3cc6cd06-89ce-4fdc-b935-5294135d6d42", False, datasource
            )
