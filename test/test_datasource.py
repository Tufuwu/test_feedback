...
class DatasourceTests(unittest.TestCase):
    ...
    def test_get(self):
        ...
        self.assertEqual(
            "2016-08-11T21:22:40Z", format_datetime(all_datasources[0].created_at)
        )
        self.assertEqual(
            "2016-08-11T21:34:17Z", format_datetime(all_datasources[0].updated_at)
        )
        self.assertEqual("default", all_datasources[0].project_name)
        self.assertEqual("SampleDS", all_datasources[0].name)
        self.assertEqual(
            "ee8c6e70-43b6-11e6-af4f-f7b0d8e20760", all_datasources[0].project_id
        )
        self.assertEqual(
            "5de011f8-5aa9-4d5b-b991-f462c8dd6bb7", all_datasources[0].owner_id
        )
        ...
        self.assertEqual(
            "2016-08-04T21:31:55Z", format_datetime(all_datasources[1].updated_at)
        )
        self.assertEqual("default", all_datasources[1].project_name)
        self.assertEqual("Sample datasource", all_datasources[1].name)
        self.assertEqual(
            "ee8c6e70-43b6-11e6-af4f-f7b0d8e20760", all_datasources[1].project_id
        )
        self.assertEqual(
            "5de011f8-5aa9-4d5b-b991-f462c8dd6bb7", all_datasources[1].owner_id
        )
        self.assertEqual(
            set(["world", "indicators", "sample"]), all_datasources[1].tags
        )
    ...
    def test_get_by_id(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl + "/9dbd2263-16b5-46e1-9c43-a76bb8ab65fb",
                text=response_xml,
            )
        ...
        self.assertEqual(
            "2016-08-04T21:31:55Z", format_datetime(single_datasource.created_at)
        )
        self.assertEqual(
            "2016-08-04T21:31:55Z", format_datetime(single_datasource.updated_at)
        )
        ...
        self.assertEqual(
            "5de011f8-5aa9-4d5b-b991-f462c8dd6bb7", single_datasource.owner_id
        )
        ...
        self.assertEqual(
            TSC.DatasourceItem.AskDataEnablement.SiteDefault,
    ...
    def test_update(self):
        ...
        self.assertEqual(
            "dd2239f6-ddf1-4107-981a-4cf94e415794", single_datasource.owner_id
        )
        self.assertEqual(True, single_datasource.certified)
        self.assertEqual(
            "Warning, here be dragons.", single_datasource.certification_note
        )
    ...
    def test_update_copy_fields(self):
        ...
        self.assertEqual(
            single_datasource._project_name, updated_datasource._project_name
        )
    ...
    def test_update_tags(self):
        ...
        with requests_mock.mock() as m:
            m.put(
                self.baseurl + "/9dbd2263-16b5-46e1-9c43-a76bb8ab65fb/tags",
                text=add_tags_xml,
            )
            m.delete(
                self.baseurl + "/9dbd2263-16b5-46e1-9c43-a76bb8ab65fb/tags/b",
                status_code=204,
            )
            m.delete(
                self.baseurl + "/9dbd2263-16b5-46e1-9c43-a76bb8ab65fb/tags/d",
                status_code=204,
            )
            m.put(
                self.baseurl + "/9dbd2263-16b5-46e1-9c43-a76bb8ab65fb", text=update_xml
            )
            single_datasource = TSC.DatasourceItem(
        ...
        self.assertEqual(single_datasource.tags, updated_datasource.tags)
        self.assertEqual(
            single_datasource._initial_tags, updated_datasource._initial_tags
        )
    ...
    def test_populate_connections(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl + "/9dbd2263-16b5-46e1-9c43-a76bb8ab65fb/connections",
                text=response_xml,
            )
            single_datasource = TSC.DatasourceItem(
                "test", "1d0304cd-3796-429f-b815-7258370b9b74"
            ...
            self.assertEqual(
                "9dbd2263-16b5-46e1-9c43-a76bb8ab65fb", single_datasource.id
            )
    ...
    def test_update_connection(self):
        populate_xml, response_xml = read_xml_assets(
            POPULATE_CONNECTIONS_XML, UPDATE_CONNECTION_XML
        )
    ...
    def test_populate_permissions(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl + "/0448d2ed-590d-4fa0-b272-a2a8a24555b5/permissions",
                text=response_xml,
            )
    ...
    def test_publish(self):
        ...
        with requests_mock.mock() as m:
            ...
            new_datasource = self.server.datasources.publish(
                new_datasource, asset("SampleDS.tds"), mode=publish_mode
            )
        ...
        self.assertEqual(
            "2016-08-11T21:22:40Z", format_datetime(new_datasource.created_at)
        )
        self.assertEqual(
            "2016-08-17T23:37:08Z", format_datetime(new_datasource.updated_at)
        )
        self.assertEqual(
            "ee8c6e70-43b6-11e6-af4f-f7b0d8e20760", new_datasource.project_id
        )
        self.assertEqual("default", new_datasource.project_name)
        self.assertEqual(
            "5de011f8-5aa9-4d5b-b991-f462c8dd6bb7", new_datasource.owner_id
        )
    ...
    def test_refresh_id(self):
        ...
        with requests_mock.mock() as m:
            m.post(
                self.baseurl + "/9dbd2263-16b5-46e1-9c43-a76bb8ab65fb/refresh",
                status_code=202,
                text=response_xml,
            )
    ...
    def test_delete(self):
        with requests_mock.mock() as m:
            m.delete(
                self.baseurl + "/9dbd2263-16b5-46e1-9c43-a76bb8ab65fb", status_code=204
            )
    ...
    def test_download(self):
        with requests_mock.mock() as m:
            m.get(
                ...
                headers={
                    "Content-Disposition": 'name="tableau_datasource"; filename="Sample datasource.tds"'
                },
            )
    ...
    def test_download_extract_only(self):
        ...
        with requests_mock.mock() as m:
            m.get(
                self.baseurl
                + "/9dbd2263-16b5-46e1-9c43-a76bb8ab65fb/content?includeExtract=False",
                headers={
                    "Content-Disposition": 'name="tableau_datasource"; filename="Sample datasource.tds"'
                },
                complete_qs=True,
            ...
            file_path = self.server.datasources.download(
                "9dbd2263-16b5-46e1-9c43-a76bb8ab65fb", include_extract=False
            )
            self.assertTrue(os.path.exists(file_path))
        os.remove(file_path)
    ...
    def test_update_missing_id(self):
        ...
        self.assertRaises(
            ...
            self.server.datasources.update,
            single_datasource,
        )
    ...
    def test_publish_tde_file_object_raises_exception(self):
        ...
        tds_asset = asset(
            os.path.join("Data", "Tableau Samples", "World Indicators.tde")
        )
    ...
    def test_publish_single_connection(self):
        ...
        response = RequestFactory.Datasource._generate_xml(
            new_datasource, connection_credentials=connection_creds
        )
        #  Can't use ConnectionItem parser due to xml namespace problems
    ...
    def test_delete_extracts(self):
        ...
        with requests_mock.mock() as m:
            ...
            self.server.datasources.delete_extract(
    ...
    def test_create_extracts(self):
        ...
        with requests_mock.mock() as m:
            ...
            self.server.datasources.create_extract(
                "3cc6cd06-89ce-4fdc-b935-5294135d6d42"
            )
    ...
    def test_create_extracts_encrypted(self):
        ...
        with requests_mock.mock() as m:
            ...
            self.server.datasources.create_extract(
                "3cc6cd06-89ce-4fdc-b935-5294135d6d42", True
            )
