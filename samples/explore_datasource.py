...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Explore datasource functions supported by the Server API."
    )
    ...
    parser.add_argument(
        "--publish", "-p", metavar="FILEPATH", help="path to datasource to publish"
    )
    parser.add_argument(
        "--download",
        "-d",
        metavar="FILEPATH",
        help="path to save downloaded datasource",
    )
    parser.add_argument(
        "--logging-level",
        "-l",
