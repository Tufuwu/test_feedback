...
def main():
    ...
    parser.add_argument(
        ...
        "-f",
        required=True,
        help="computer filepath of the workbook to publish",
    )
    parser.add_argument(
        "--logging-level",
        "-l",
    ...
    parser.add_argument(
        "--as-job", "-a", help="Publishing asynchronously", action="store_true"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--site", "-S", default="", help="id (contentUrl) of site to sign into"
    )
